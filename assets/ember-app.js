...
define('ember-app/controllers/i-i-s-novyjj-testovyjj-main-class-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-novyjj-testovyjj-main-class-l'
  });
});
define('ember-app/controllers/i-i-s-novyjj-testovyjj-main-class-e/new', ['exports', 'ember-app/controllers/i-i-s-novyjj-testovyjj-main-class-e'], function (exports, _iISNovyjjTestovyjjMainClassE) {
  'use strict';
  ...
  var IISNovyjj_testovyjjMainClassENewController = _iISNovyjjTestovyjjMainClassE.default;
  exports.default = IISNovyjj_testovyjjMainClassENewController;
});
define('ember-app/controllers/i-i-s-novyjj-testovyjj-main-class-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-novyjj-testovyjj-main-class-e'
     */
    editFormRoute: 'i-i-s-novyjj-testovyjj-main-class-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-novyjj-testovyjj-main-class-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-novyjj-testovyjj-main-class-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-novyjj-testovyjj-main-class', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-novyjj-testovyjj-main-class-l', 'ember-app/locales/en/forms/i-i-s-novyjj-testovyjj-main-class-e', 'ember-app/locales/en/models/i-i-s-novyjj-testovyjj-main-class'], function (exports, _translations, _iISNovyjjTestovyjjMainClassL, _iISNovyjjTestovyjjMainClassE, _iISNovyjjTestovyjjMainClass) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-novyjj-testovyjj-main-class': _iISNovyjjTestovyjjMainClass.default
    },
    ...
    forms: {
      ...
      'i-i-s-novyjj-testovyjj-main-class-l': _iISNovyjjTestovyjjMainClassL.default,
      'i-i-s-novyjj-testovyjj-main-class-e': _iISNovyjjTestovyjjMainClassE.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-novyjj-testovyjj-main-class-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-novyjj-testovyjj-main-class-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-novyjj-testovyjj-main-class', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-novyjj-testovyjj-main-class-l', 'ember-app/locales/ru/forms/i-i-s-novyjj-testovyjj-main-class-e', 'ember-app/locales/ru/models/i-i-s-novyjj-testovyjj-main-class'], function (exports, _translations, _iISNovyjjTestovyjjMainClassL, _iISNovyjjTestovyjjMainClassE, _iISNovyjjTestovyjjMainClass) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-novyjj-testovyjj-main-class', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-novyjj-testovyjj-main-class-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-novyjj-testovyjj-main-class', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-novyjj-testovyjj-main-class', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-novyjj-testovyjj-main-class'], function (exports, _emberCpValidations, _model, _iISNovyjjTestovyjjMainClass) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISNovyjjTestovyjjMainClass.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISNovyjjTestovyjjMainClass.Model, Validations, {});

  (0, _iISNovyjjTestovyjjMainClass.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-novyjj-testovyjj-main-class-e', { path: 'i-i-s-novyjj-testovyjj-main-class-e/:id' });
    this.route('i-i-s-novyjj-testovyjj-main-class-e.new', { path: 'i-i-s-novyjj-testovyjj-main-class-e/new' });
  });
...
define('ember-app/routes/i-i-s-novyjj-testovyjj-main-class-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    modelProjection: 'MainClassE',
    modelName: 'i-i-s-novyjj-testovyjj-main-class'
  });
});
define('ember-app/routes/i-i-s-novyjj-testovyjj-main-class-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'MainClassE',
    modelName: 'i-i-s-novyjj-testovyjj-main-class',
    templateName: 'i-i-s-novyjj-testovyjj-main-class-e'
  });
});
define('ember-app/routes/i-i-s-novyjj-testovyjj-main-class-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @default 'MainClassL'
    */
    modelProjection: 'MainClassL',

    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-novyjj-testovyjj-main-class'
    */
    modelName: 'i-i-s-novyjj-testovyjj-main-class',
    ...
    */
    developerUserSettings: Ember.computed(function () {
      return { IISNovyjj_testovyjjMainClassL: {} };
    })
  });
});
...
define('ember-app/serializers/i-i-s-novyjj-testovyjj-main-class-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-novyjj-testovyjj-main-class-offline', 'ember-app/serializers/application-offline'], function (exports, _iISNovyjjTestovyjjMainClassOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISNovyjjTestovyjjMainClassOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-novyjj-testovyjj-main-class', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-novyjj-testovyjj-main-class', 'ember-app/serializers/application'], function (exports, _iISNovyjjTestovyjjMainClass, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISNovyjjTestovyjjMainClass.Serializer, {
    /**
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-novyjj-testovyjj-main-class': 'id,iD'
      });
